...
Type TPlayer 
	Field x#,y#,xs#,ys#
	Field rot#,alpha#,img:TImage,frame=2
	...
	Function CreatePlayer()
		player=New TPlayer
		player.x=320; player.xs#=0
		player.y=240; player.ys#=0
...
'			If CollideImage(img,x,y,frame,2,0) Then hit() ' Player/Ground Collision
	...
	Method fire()
		...
		Select primary_weapon
			...
			Case WPN_NORMAL
					TBullet.CreateBullet x+24,y+2+(ys*2),(16+spd)*direction		
					pshot_timer=5
			...
			Case WPN_DEFLASER
				...
				For Local sp=1 To 8
					TBullet.CreateBullet x+24,y+2+(ys*2),(16+sp)*direction
				Next
				pshot_timer=5
				PlaySound player_shot, SoundChannel
