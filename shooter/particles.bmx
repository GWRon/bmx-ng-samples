...
Global spark1:TImage,spark2:TImage,spark3:TImage,explosion:TImage, smoke:TImage
Global mult_img:TImage, score_decal:TImage
...
Type TParticle 
	...
	Function CreateSpark:Tparticle(img:TImage,x#,y#,sc#,si#,sp#,gr#, lf)
